...
impl Order {
    ...
    //getters
    pub fn product_name(&self) -> &String { // return the reference only as type &String (So we use & since we dont own it)
        &self.product_name
    }
    ...
    pub fn set_quantity(&mut self, new_quantity: u64) {
        ...
        // validations while updating/setting the pvt values
    }
